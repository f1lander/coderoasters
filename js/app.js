...
app.config(function ($translateProvider) {
  $translateProvider.translations('en', {    
    ...
    ABOUT5: 'We are a small team of software developers based in San Pedro Sula, Cortés, Honduras',
    ...
    WEBDEVDESC: 'We make awesome web applications with the latest technologies',
  ...
  */
  ...
  $translateProvider.translations('es', {
    ...
    HOME: 'Inicio',
    TITLE: 'Code Roasters',
    GREETINGS: 'Convertimos tus ideas en software',
    ...
    ABOUT5: 'Somos un pequeño equipo de desarrolladores de software establecido en San Pedro Sula, Cortés, Honduras',
    ...
    OURTEAMSUB:'¡Déjanos darte la mejor experiencia construyendo tus ideas!',
    SERVICESDESC: 'Algunos de nuestros servicios son',
    WEBDEV: 'Desarrollo Web',    
    WEBDEVDESC: 'Aplicaciones web a tu medida, te damos soluciones con las mejores tecnologías',
    MOBILEDEV:'Desarrollo para Móviles',
    MOBILEDEVDESC:'¿Necesitas una app móvil? Android o iOS, desarrollamos lo que quieras',
